...
// used elsewhere in this project (AISection, HeroSponsors).
const CHATGPT_PATH =
...
const AI_TOOLS: { name: string; path: string; from: string; to: string; mono?: boolean }[] = [
  { name: 'ChatGPT', path: CHATGPT_PATH, from: '#10a37f', to: '#0d7d63' },
  { name: 'Claude', path: CLAUDE_PATH, from: '#e08a68', to: '#c26841' },
  { name: 'Gemini', path: GEMINI_PATH, from: '#a68fd1', to: '#8e75b2' },
  { name: 'DeepSeek', path: DEEPSEEK_PATH, from: '#6f9bff', to: '#5786fe' },
  { name: 'Meta AI', path: META_PATH, from: '#3d8bff', to: '#0467df' },
  { name: 'Mistral AI', path: MISTRAL_PATH, from: '#ff7a3d', to: '#fa520f' },
  { name: 'Perplexity', path: PERPLEXITY_PATH, from: '#3fd8c9', to: '#1fb8cd' },
  { name: 'GitHub Copilot', path: COPILOT_PATH, from: '#f4f4f5', to: '#d4d4d8', mono: true },
]
  ...
  return (
    <section className="relative overflow-hidden py-24 sm:py-28">
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        >
          Aprenda a dominar as <span className="text-[#6ee7a0]">PRINCIPAIS IAs</span> do mercado
          com toda a didática que você precisa
        </motion.h2>
        ...
        >
          ...
          <div className="relative p-8 sm:p-12">
            ...
            <h3 className="mt-4 text-white font-light text-[clamp(22px,3.5vw,36px)] leading-[1.2] tracking-[-0.02em] max-w-2xl">
              Domine as IAs mais usadas do mercado, <span className="font-medium text-[#6ee7a0]">na prática</span>
            </h3>

            <div className="mt-8 flex flex-wrap gap-3.5 sm:gap-4">
              {AI_TOOLS.map(({ name, path, from, to, mono }) => (
                <span
                  key={name}
                  title={name}
                  ...
                  style={{
                    ...
                    boxShadow: `0 8px 20px -6px ${mono ? 'rgba(0,0,0,0.35)' : `${from}77`}`,
                  }}
                >
                  <svg viewBox="0 0 24 24" width={22} height={22} fill={mono ? '#111827' : '#fff'}>
                    <path d={path} />
                  </svg>
                </span>
              ))}
            ...
            <p className="mt-8 text-white/50 text-[14px] sm:text-[15px] leading-relaxed max-w-2xl">
              Você não precisa aprender sozinho, na base da tentativa e erro. Na Dev Club, você tem
              aulas práticas e diretas ao ponto para dominar ChatGPT, Claude, Gemini e todas as
              principais IAs do mercado — do primeiro prompt até as automações mais avançadas do
              seu dia a dia.
            </p>
